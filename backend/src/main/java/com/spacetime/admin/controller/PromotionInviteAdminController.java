...
public class PromotionInviteAdminController {
    ...
    /** 分页查询邀请关系 */
    @GetMapping({"/admin/promotion/invites/list", "/admin/promotion/invite-relations/list"})
    ...
    /** 查询邀请关系详情 */
    @GetMapping({"/admin/promotion/invites/{id}", "/admin/promotion/invite-relations/{id}"})
    @RequirePermission("promotion:invite:list")
    ...
    /** 解除邀请关系冻结 */
    @PutMapping("/admin/promotion/invite-relations/{id}/unfreeze")
    ...
    /** 标记邀请关系无效 */
    @PutMapping("/admin/promotion/invite-relations/{id}/invalid")
    @RequirePermission("promotion:invite:review")
