...
function CommunityCard({ post, optionLabel, isSelf, onAuthor, onOpen, onTopic, onComment, onContact, onMore, onFollow, onLike }: { post: CommunityPostVO; optionLabel: (type: string, code: string) => string; isSelf: boolean; onAuthor: () => void; onOpen: () => void; onTopic: () => void; onComment: () => void; onContact: () => void; onMore: () => void; onFollow: () => void; onLike: () => void }) {
  ...
  return <View style={{ width: '700rpx', borderRadius: '18rpx', background: '#FFFFFF', marginBottom: '20rpx', padding: '33rpx 26rpx 0', boxSizing: 'border-box', overflow: 'hidden' }}>
    ...
    {post.topicName ? <View onClick={onTopic} style={{ maxWidth: '300rpx', height: '48rpx', borderRadius: '24rpx', background: '#EFF4FC', padding: '0 18rpx', marginTop: '23rpx', marginLeft: '7rpx', display: 'inline-flex', alignItems: 'center', boxSizing: 'border-box' }}><Image src={miniappOssIcons.qianxunTopicTagHash} mode="aspectFit" style={{ width: '20rpx', height: '20rpx', marginRight: '8rpx', flexShrink: 0 }} /><Text style={{ minWidth: 0, color: '#666666', fontSize: '26rpx', lineHeight: '37rpx', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{post.topicName}</Text></View> : null}
