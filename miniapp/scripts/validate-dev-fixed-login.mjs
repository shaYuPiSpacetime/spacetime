...
assert.match(config, /enabled: false\s*,/, '当前调试流程必须关闭固定登录')
...
assert.match(packageJson, /"dev:weapp": "MINIAPP_DEV_FIXED_LOGIN=false npm run build:weapp -- --watch"/, '微信开发监听必须从登录页启动')
