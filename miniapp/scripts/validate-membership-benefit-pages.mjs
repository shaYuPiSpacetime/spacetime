...
assert.ok(subscriptionPage.includes('getVipStatus') && subscriptionPage.includes('getVipPackages'), '订阅管理必须通过真实接口加载状态和套餐')
assert.ok(!subscriptionPage.includes('getDemoPageData'), '订阅管理生产路径不得使用演示数据')
