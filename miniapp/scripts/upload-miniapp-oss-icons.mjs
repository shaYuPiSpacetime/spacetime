...
const ICON_ASSETS = Object.freeze({
  ...
  loginAgreementChecked: 'src/assets/lanhu/login/login-agreement-checked.png',
  ...
  verificationEducationSubmitSuccess: 'src/assets/lanhu/verification/education-success-mcp-2026-08-25/icon-1.png',
  verificationAvatarGuidePortrait: 'src/assets/lanhu/verification/avatar-mcp-2026-08-25/avatar-guide-portrait.png',
  verificationAvatarGuideCheck: 'src/assets/lanhu/verification/avatar-mcp-2026-08-25/avatar-guide-check.png',
  verificationAvatarRuleSelf: 'src/assets/lanhu/verification/avatar-mcp-2026-08-25/avatar-rule-self.png',
  verificationAvatarRuleClear: 'src/assets/lanhu/verification/avatar-mcp-2026-08-25/avatar-rule-clear.png',
  verificationAvatarRuleBest: 'src/assets/lanhu/verification/avatar-mcp-2026-08-25/avatar-rule-best.png',
  verificationAvatarInvalidNonPerson: 'src/assets/lanhu/verification/avatar-mcp-2026-08-25/avatar-invalid-non-person.png',
  verificationAvatarInvalidLandscape: 'src/assets/lanhu/verification/avatar-mcp-2026-08-25/avatar-invalid-landscape.png',
  verificationAvatarInvalidBlurred: 'src/assets/lanhu/verification/avatar-mcp-2026-08-25/avatar-invalid-blurred.png',
  verificationAvatarInvalidNoFace: 'src/assets/lanhu/verification/avatar-mcp-2026-08-25/avatar-invalid-no-face.png',
  ...
  qianxunTopicTagHash: '../page/lanhu-mcp-assets/slices/qianxun-family-hot-cb77f45b/icon-1.png',
  qianxunPublishPlus: '../page/lanhu-mcp-assets/slices/qianxun-family-hot-cb77f45b/icon-2.png',
  qianxunTopicSectionHash: '../page/lanhu-mcp-assets/slices/qianxun-family-hot-cb77f45b/icon-3.png',
  qianxunTopicFeaturedHash: '../page/lanhu-mcp-assets/slices/qianxun-family-hot-cb77f45b/icon-4.png',
  qianxunTopicRelatedHash: '../page/lanhu-mcp-assets/slices/qianxun-family-hot-cb77f45b/icon-5.png',
  ...
  recommendCertScoreShield: 'src/assets/lanhu/recommend/triple-certification-popup-2026-08-25/icon-1.png',
  recommendCertRealName: 'src/assets/lanhu/recommend/triple-certification-popup-2026-08-25/icon-2.png',
  recommendCertAvatar: 'src/assets/lanhu/recommend/triple-certification-popup-2026-08-25/icon-3.png',
  recommendCertEducation: 'src/assets/lanhu/recommend/triple-certification-popup-2026-08-25/icon-4.png',
