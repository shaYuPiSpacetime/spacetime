...
| 关系操作 | 他人主页资料区下方 | 未建立关系展示“申请认识”；已建立关系展示消息动作并直达 PRD-03；同时展示关注态 | 否 | 否 |
...
| `APP-05-PAGE-user-posts-ACT-chat` | 发消息 | 他人主页资料区 | 已建立互动关系且会话可用 | `M05-RULE-community-contact-routing`、`M03-RULE-private-chat-open` | 否 | 直接进入 `APP-03-PAGE-private-chat` | 由 PRD-03 会话页提示原因 |
