# 页面规格 - APP-05-PAGE-user-posts 个人动态区
...
- **目标用户**：已登录用户
- **核心任务**：查看本人或他人的动态内容；本人可查看审核状态并删除，他人仅查看公开内容
- **页面类型**：列表页
...
| `APP-05-user-posts-02` | 个人动态区-他人 | 仅公开动态 | |
...
| 业务态-pending_manual | 本人内容待复核 | 状态标签 | 查看 | `M05-SM-content-audit` |
| 业务态-rejected | 本人内容驳回 | 状态标签 + 原因入口 | 查看原因 | `M05-SM-content-audit` |
