...
| 理想型用户/觅缘回看记录 | 推荐/觅缘链路 | 推荐与觅缘回看 | 对应解锁入口隐藏或空态 |
...
| `APP-04-RULE-unlock` | 喜欢/访客/理想型/觅缘回看按次解锁 | P0 | `APP-04-PAGE-paywall-modal` | 具体业务页面引用本规则 |
...
| 推荐/觅缘链路 | PRD-05/一期觅缘页面 | 理想型、觅缘回看记录 | 相关入口隐藏或空态 | 非阻塞 |
