...
|---------|--------|------|----------|----------|----------|--------|--------|
| `APP-02-PAGE-single-unlock-modal-ACT-unlock-one` | 只看ta | 主按钮 | 余额充足且记录有效 | 已登录且核心准入开放 | 是，确认扣减千寻币 | 当前记录清晰，写 PRD-04 解锁记录和资产流水 | 余额不足、记录不可解锁、扣币失败 |
...
| 余额不足态 | balance < cost | 展示快捷充值/充值页承接 | 充值/更多套餐 | `APP-04-PAGE-paywall-modal` |
