...
const targetFiles = [
  ...
  ...['APP-03_成家热门信息流页.md', 'APP-04_话题列表页.md', 'APP-05_发布动态页.md', 'APP-06_动态详情页.md', 'APP-07_话题详情页.md', 'APP-08_举报弹窗.md', 'APP-09_悦目页.md', 'APP-12_个人动态区.md', 'APP-13_社区打招呼页.md', 'APP-15_社区更多操作弹窗.md', 'APP-17_关注粉丝列表页.md', 'APP-18_动态互动用户列表页.md']
