window.DEMO_DATA = {
  ...
  vipBenefits: [
    { code: 'heart_list', name: '心动名单一键揭晓', adminName: '心动名单', desc: '有人对你心动了，看到喜欢的，立即发起对话', type: '心动名单', enabled: true, configType: '开关', mobileIcon: 'icon-heart-list' },
    { code: 'visitor_list', name: '谁来看过你', adminName: '访客', desc: '访客全公开，别让在意你的人白等', type: '访客', enabled: true, configType: '开关', mobileIcon: 'icon-visitor' },
    { code: 'free_whisper', name: '每日专属悄悄话', adminName: '免费悄悄话', desc: '消息直接弹到对方主页，第一时间抓住 ta 的目光', type: '免费悄悄话', enabled: true, configType: '次数', configValue: 1, mobileIcon: 'icon-whisper' },
    { code: 'extra_browse', name: '每日额外浏览', adminName: '额外浏览', desc: '每天额外浏览更多嘉宾，发现更契合的人', type: '额外浏览', enabled: true, configType: '次数', configValue: 10, mobileIcon: 'icon-browse-plus' },
    { code: 'advanced_filter', name: '精准筛选功能', adminName: '高级筛选', desc: '按你条件定向筛选，只看最合心意的人', type: '高级筛选', enabled: true, configType: '开关', mobileIcon: 'icon-filter' },
    { code: 'exposure_score', name: '曝光度拉满', adminName: '曝光', desc: '资料优先展示给活跃用户和你心仪的对象', type: '曝光', enabled: true, configType: '分数', configValue: 80, mobileIcon: 'icon-exposure' },
    { code: 'privacy', name: '隐身模式', adminName: '隐私权益', desc: '只对你选中的人可见，主动权完全在你手上', type: '隐私权益', enabled: true, configType: '开关', mobileIcon: 'icon-privacy' },
    { code: 'three_day_replay', name: '三天回放功能', adminName: '三天回放', desc: '最近 3 天错过的缘分都能找回，手滑也不怕', type: '三天回放', enabled: true, configType: '开关', mobileIcon: 'icon-replay-3d' },
    { code: 'daily_heart_chance', name: '每日心动机会', adminName: '每日心动机会', desc: '每天额外获得更多心动机会，让缘分不被错过', type: '每日心动机会', enabled: true, configType: '次数', configValue: 5, mobileIcon: 'icon-heart-chance' },
  ],
  vipPackages: [
