...
> **历史归档（2026-08-07）**：本文记录 2026-07-14 的 Mock/UI 实现，旧的忽略、取消、隐藏和接口
> 契约不再有效。业务开发与联调统一以 2026-07-31 主技术方案和 mobile-api-handoff 为准；本文只可
> 用于追溯当时的视觉资产与 Mock 实现。

> 日期：2026-07-14
> 适用端：Taro 4.1.9 / React 18 微信小程序
> 视觉基线：蓝湖项目“时空邂逅0625”最新 15 张消息稿，375×812 逻辑视口
> 当前后端契约：`docs/技术方案/2026-07-31-消息、私信与通知中心-mobile-api-handoff.md`
...
以下内容仅记录历史 Mock。当前完整定义见 `2026-07-31-消息、私信与通知中心-mobile-api-handoff.md`。
